...
\begin{theorem}[Malicious Completeness]
  ...
  We then have:
  \begin{enumerate}
    \item $\mathcal{P} =_{\mathcal{C}} \mathcal{Q} \implies \mathcal{P} =_{\mathcal{C}'} \mathcal{Q}$,
    \item $\mathcal{P} \overset{\epsilon}{\approx}_{\mathcal{C}} \mathcal{Q} \implies \mathcal{P} \overset{\epsilon}{\approx}_{\mathcal{C}'} \mathcal{Q}$,
  \end{enumerate}
  Furthermore, if for any $C \in \mathcal{C}$ and its related model $C' \in \mathcal{C}$,
  there exists a simulator $S_{\tx{M}}$ such that $\tx{Inst}_C(\mathcal{Q}) = \tx{SimInst}_{S_{\tx{M}}, C'}(\mathcal{Q})$,
  then it additionally holds that:
  \begin{enumerate}
    \setcounter{enumi}{2}
    \item $\mathcal{P} \overset{\epsilon}{\leadsto}_{\mathcal{C}} \mathcal{Q} \implies \mathcal{P} \overset{\epsilon}{\leadsto}_{\mathcal{C}'} \mathcal{Q}$
  \end{enumerate}
...
\begin{theorem}[Global Malicious Completeness]
  ...
  Furthermore, if for any $C \in \mathcal{C}$ and its related model $C' \in \mathcal{C}$,
  there exists a simulator $S_{\tx{M}}$ such that $\tx{Inst}^G_C(\mathcal{Q}) = \tx{SimInst}^G_{S_{\tx{M}}, C'}(\mathcal{Q})$,
  then it additionally holds that:
  \begin{enumerate}
    \setcounter{enumi}{2}
    \item $\mathcal{P} \overset{\epsilon}{\leadsto}^G_{\mathcal{C}} \mathcal{Q} \implies \mathcal{P} \overset{\epsilon}{\leadsto}^G_{\mathcal{C}'} \mathcal{Q}$
  \end{enumerate}
  ...
  that this is:
  $$
  \tx{SimInst}^G_{(S_{\tx{SH}} \circ S \circ S_{\tx{M}}), C'}(\mathcal{Q})
  $$
  concluding our proof.
...
\begin{lemma}[Deidealization Lemma]
  ...
  The leakage of $\mathcal{G}$ will simply be $\mathcal{P}.\tx{Leakage} \cap \tx{Out}(G)$.
