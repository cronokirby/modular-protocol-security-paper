...
\begin{theorem}[Malicious Completeness]
  ...
  \begin{enumerate}
    ...
    \item $\mathcal{P} \overset{\epsilon}{\leadsto}_{C} \mathcal{Q} \implies \mathcal{P} \overset{\epsilon}{\leadsto}_{C'} \mathcal{Q}$.
  \end{enumerate}
  ...
  For part 3, we can apply the same reasoning as in Theorem~\ref{thm:prot_trans},
  where we showed that simulation is transitive.
  By assumption we have
  $$
  \tx{Inst}_C(\mathcal{P}) \overset{\epsilon}{\approx} \tx{SimInst}_{S', C}(\mathcal{Q})
  $$
  for some simulator $S'$.
  Unrolling and applying interchange makes the right side become:
  $$
  \begin{pmatrix}
    S_{\tx{SH}} \circ S'\cr
    \otimes\cr
  ...
  $$
  with $S_{\tx{SH}} \circ S'$ being a valid simulator, thus concluding our proof.
