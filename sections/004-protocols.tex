...
Given a set of players $P_1, \ldots, P_n$, a \emph{corruption model} $C$
...
\begin{itemize}
  ...
  and the agent for the remaining player is an arbitrary efficient package.
  \item The class of malicious corruptions, where all but one player is semi-honest,
  and the agents for each player are arbitrary efficient packages.
\end{itemize}