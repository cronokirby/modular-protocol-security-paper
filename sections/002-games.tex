...
\begin{definition}[Package Composition]
    ...
    $$
    (h_1, \ldots, h_{B.m}) \mapsto A.f_i[B.f_1[h_1, \ldots], \ldots, B.f_{B.n}[h_1, \ldots]]
    $$
...
\begin{lemma}[Associativity of Composition]
    ...
    $$
    (h_1, \ldots) \mapsto B.f_i[C.f_1[h_1, \ldots], \ldots]
    $$
    And then the functions in $A \circ (B \circ C)$ are of the form:
    $$
    (h_1, \ldots) \mapsto A.f_i[B.f_1[C.f_1[h_1, \ldots]], \ldots]
    $$

    From the other side, the functions in $A \circ B$ are of the form:
    $$
    (h_1, \ldots) \mapsto A.f_i[B.f_1[h_1, \ldots], \ldots]
    $$
