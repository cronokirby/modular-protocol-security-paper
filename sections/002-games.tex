...
\begin{definition}[Advantage Bound]
    ...
    consists of an increasing function $f_\epsilon : \mathbb{R}^n \to \mathbb{R}^n$,
...
One common shorthand we use here is to say that $G_0 \overset{H_b}{\approx} G_1$.
This bound could be more complicated, involving several games and even
